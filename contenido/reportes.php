<form action="reportes/seleccion.php" method="post" target="_blank">
        	...
        	<table width="100%" align="center" cellpadding="3" cellspacing="3" class="MedianoAzul">
        		<tr>
		            ...
		            <td align="left" class="MedianoAzulOscuro">
        		    	<select name="reporte">
 							<option value="1">CONCENTRADO POR PROCESO CLAVE Y ESTRATEGICO</option>
                            <option value="2">CONCENTRADO POR PARTIDA PRESUPUESTAL Y PROCESO ESTRATEGICO</option>
                            ...
                            <option value="5">LISTADO DE BIENES INFORMATICOS</option>
                            <option value="6">LISTADO DE EQUIPOS Y APARATOS DE COMUNICACIONES Y TELECOMUNICACIONES</option>
                            <option value="7">DESCRIPCION DE LAS METAS DEL PTA USADAS EN LOS FORMATOS</option>
						</select>
					</td>
				</tr>
                <tr>
