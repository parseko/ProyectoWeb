		...
		if ( $row_poa['iniciado'] == 1 )
		{
			...
			if ( $_GET['dep'] != 1)
			{
				...
				{	
					...
					echo "<tr>";
					echo "<td class='PoaTitulo' colspan='2'><strong>CARGAR GASTOS POR DEPARTAMENTOS</strong></td>";
					echo "</tr>";
					while ( $row_dpto = mysql_fetch_assoc ( $res_dpto ) )
					{
						...
						echo "<td class='PoaDatos'><a href='index.php?sec=3&dep=1&id={$row_dpto['id']}'><img src='imagenes/calculator_edit.gif' border='0'></a></td>";
...
<?php
								...
								if ( $row_poa = mysql_fetch_assoc ( $res_poa ) )
								{}
								$sql_metas = "SELECT * FROM poa_dpto_gastos WHERE dpto_id = {$_SESSION['DPTO']} and idpoa = {$row_poa['id']} GROUP BY idacciones";
