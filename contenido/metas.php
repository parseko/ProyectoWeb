	...
	if ( $row_poa = mysql_fetch_assoc ( $res_poa ) )
	{
		if ( $row_poa['iniciado'] == 1 and $row_poa['terminado'] == 0 )
		{
			if ( isset ( $_POST['ingresar'] ) )
			{
				...
				{	
					$sql = "INSERT INTO preacciones ( claveaccion, accion , enero, julio, idmeta, idpoa ) VALUES ( {$_POST['Clave']}, '{$_POST['Acci']}', '{$_POST['enero']}', '{$_POST['julio']}',   {$_POST['Accion']}, {$row_poa['id']} )";
		...
		<?php
						$sql_proyecto = "SELECT * FROM accion WHERE 1 ORDER BY claveAccion";
		...
		?>
							...
							<tr>
								...
								<td align="left" width="65%" class="v"><input name="Clave" type="text" class="ControlesTexto2" /></td>
							</tr>
							<tr>
								<td align="right" width="35%" class="MedianoAzulOscuro"><strong>Accion:</strong></td>
								<td align="left" width="65%" class="MedianoAzulOscuro"><textarea name="Acci" cols="30" rows="5">
</textarea></td>
							</tr>
							<tr>
							  <td align="right" class="MedianoAzulOscuro"><strong>Enero-Junio:</strong></td>
							  <td align="left" class="MedianoAzulOscuro"><input name="enero" type="text" class="ControlesTexto2" id="enero" /></td>
						  </tr>
							<tr>
							  <td align="right" class="MedianoAzulOscuro"><strong>Julio-Diciembre:</strong></td>
							  <td align="left" class="MedianoAzulOscuro"><input name="julio" type="text" class="ControlesTexto2" id="julio" /></td>
						  </tr>
