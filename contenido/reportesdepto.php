        		...
        		<tr>
		            ...
		            <td align="left" class="MedianoAzulOscuro">
        		    	<select name="reporte">
                            ...
                            <option value="5">LISTA DE MOVIMIENTOS</option>
                            <option value="6">DESGLOSE DE GASTOS POR CAPITULO DE GASTO</option>
                            <option value="7">DESGLOCE DE GASTOS POR META Y CAPITULO DE GASTO</option>
						</select>
					</td>
				</tr>
                <tr>
