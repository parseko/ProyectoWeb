				...
				while ( $row_accion = mysql_fetch_assoc ( $res_accion ) )
				{
					...
					while ( $row_apoa1 = mysql_fetch_assoc ( $res_apoa1 ) )
					{
						...
						while ( $row_metas = mysql_fetch_assoc ( $res_metas ) )
						{
							...
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(159,$x);
							$this->Cell(11,4,$partida1000total,'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(170,$x);
							$this->Cell(11,4,$partida2000total,'LR',2,'C',1);
												
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(181,$x);
							$this->Cell(11,4,$partida2000total2,'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(192,$x);
							$this->Cell(11,4,$partida3000total,'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(203,$x);
							$this->Cell(11,4,$partida3000total2,'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(214,$x);
							$this->Cell(11,4,$partida5000total,'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(225,$x);
							$this->Cell(11,4,$partida7000total,'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(236,$x);
							$this->Cell(11,4,$partida7000total2,'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(247,$x);
							$this->Cell(11,4,($partida1000total+$partida2000total+$partida3000total+$partida5000total+$partida7000total),'LR',2,'C',1);
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(258,$x);
							$this->Cell(11,4,($partida2000total2+$partida3000total2+$partida7000total2),'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(269,$x);
							$this->Cell(15,4,($partida1000total+$partida2000total+$partida3000total+$partida5000total+$partida7000total+$partida2000total2+$partida3000total2+$partida7000total2),'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(284,$x);
							$this->Cell(11,4,$enerototaltipo1,'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(295,$x);
							$this->Cell(11,4,$enerototaltipo2,'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(306,$x);
							$this->Cell(11,4,$enerototal,'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(317,$x);
							$this->Cell(11,4,$juliototaltipo1,'LR',2,'C',1);	
														
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(328,$x);
							$this->Cell(11,4,$juliototaltipo2,'LR',2,'C',1);	
											
							$this->SetFont('Arial','B',5.5);
							$this->SetXY(339,$x);
							$this->Cell(11,4,$juliototal,'LR',2,'C',1);
