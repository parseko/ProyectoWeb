<?php
	...
	class poa1_anexo2 extends FPDF
	{
		...
		{	
			...
			$this->Cell(0,0,'Formato de Desglose del Presupuesto de Inversión con Cargo a Ingresos Propios',0,0,'C');
			$this->Ln(3);
			$this->Cell(0,5,'Referencia a la Norma ISO 9001-2000: 6.1',0,0,'C');		
			$this->Ln(10);
