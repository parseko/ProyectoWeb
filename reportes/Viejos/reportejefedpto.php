<?php
	...
	class poa1_anexo2 extends FPDF
	{
		...
		function Footer(  )
		{
			...
			$X = $this->GetX();
			$Y = $this->GetY();
			$this->MultiCell(60,5,"AUTORIZACIÓN ENCARGADO DE DESPACHO D.G.E.S.T.",0,'C');
	...
	$pdf->Ln(15);
	$pdf->Cell(80,5,"No. DE OFICIO DE SOLICITUD:",0,0,'L');
	$pdf->Cell(100,5,"{$_POST['oficio']}",0,0,'L');
	$pdf->Ln(5);
	$pdf->Cell(80,5,"FECHA DE SOLICITUD:",0,0,'L');
	$pdf->Cell(100,5,"{$_POST['fecha_sol']}",0,0,'L');
	$pdf->Ln(5);
	$pdf->Cell(80,5,"FECHA O PERIODO DE REALIZACION:",0,0,'L');
	$pdf->Cell(100,5,"{$_POST['fecha_real']}",0,0,'L');
