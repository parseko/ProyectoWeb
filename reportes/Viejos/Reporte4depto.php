...
class ReporteHorario extends FPDF
{
	...
	{	
		...
		$this->SetXY(113,10);
		$this->Cell(45,4,"INSTITUTO TECNOLÓGICO DE TUXTLA GUTIÉRREZ",0,2,'L');
		
		$this->SetFont('Arial','B',7.5);
		$this->SetXY(108,14);
		$this->Cell(45,4,"ANTEPROYECTO DEL PROGRAMA OPERATIVO ANUAL 200_",0,2,'L');
		...
		$bdd = "sicopre";
				...
				while ( $row_capitulo5000 = mysql_fetch_assoc ( $res_capitulo5000 ) )
				{
					...
					while ( $row_capitulo5000a = mysql_fetch_assoc ( $res_capitulo5000a ) )
					{
						...
						//segunda linea
						if ( strlen ( $row_capitulo5000a['justificacion'])  < 80)
						{
							$temp=$x;
