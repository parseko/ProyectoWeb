...
class ReporteHorario extends FPDF
{
	...
	{	
		...
		$this->SetXY(296,$x+6);
		$this->Cell(39,6,"A TRAVÉS DE",LBR,2,'C',1);
		...
		$this->SetFont('Arial','B',7.2);
		$this->SetXY(257,$x);
		$this->Cell(39,4,"5. ADMINISTRACIÓN",LTR,2,'C',1);
		$this->SetXY(257,$x+4);
		...
		$this->SetXY(101,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(39,4,"REMANENTE",1,2,'R',1);
	...
	function parteII()
	{
		...
		if ( $row_apoa = mysql_fetch_assoc ( $res_apoa ) )
		{
			...
			while ( $row_partida = mysql_fetch_assoc ( $res_partida ) )
			{
				if($row_partida['clavepartida'] >= 1000 and $row_partida['clavepartida'] <= 1999)
				{
					...
					//GASTOS 1000
					$sql_deptoapoa = "SELECT * FROM gastos_dpto  WHERE idpartida='{$row_partida['id']}' AND donde = 'Remanente' ";
					$res_deptoapoa = mysql_db_query ( $bdd, $sql_deptoapoa );
					while ( $row_deptoapoa = mysql_fetch_assoc ( $res_deptoapoa ) )
					{
						$_SESSION['Candado']=1;
					...
					{	
						...
						$this->SetXY(101,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $academico, 2, '.', ',' ),1,2,'R',1);*/
									
						$this->SetFont('Arial','B',6);
						$this->SetXY(101,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $academico1, 2, '.', ',' ),1,2,'R',1);

						/*$this->SetFont('Arial','B',6);
						$this->SetXY(127,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( ($academico-$academico1), 2, '.', ',' ),1,2,'R',1);*/
						
						//VINCULACION
						/*$this->SetFont('Arial','B',6);
						$this->SetXY(140,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $vinculacion, 2, '.', ',' ),1,2,'R',1);*/
									
						$this->SetFont('Arial','B',6);
						$this->SetXY(140,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $vinculacion1, 2, '.', ',' ),1,2,'R',1);

						/*$this->SetFont('Arial','B',6);
						$this->SetXY(166,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( ($vinculacion-$vinculacion1), 2, '.', ',' ),1,2,'R',1);*/
						
						//PLANEACION
						/*$this->SetFont('Arial','B',6);
						$this->SetXY(179,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $planeacion, 2, '.', ',' ),1,2,'R',1);*/
	
						$this->SetFont('Arial','B',6);
						$this->SetXY(179,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $planeacion1, 2, '.', ',' ),1,2,'R',1);

						/*$this->SetFont('Arial','B',6);
						$this->SetXY(205,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( ($planeacion-$planeacion1), 2, '.', ',' ),1,2,'R',1);*/
						
						//CALIDAD
						/*$this->SetFont('Arial','B',6);
						$this->SetXY(218,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $calidad, 2, '.', ',' ),1,2,'R',1);*/
									
						$this->SetFont('Arial','B',6);
						$this->SetXY(218,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $calidad1, 2, '.', ',' ),1,2,'R',1);

						/*$this->SetFont('Arial','B',6);
						$this->SetXY(244,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( ($calidad-$calidad1), 2, '.', ',' ),1,2,'R',1);*/
						
						//ADMINISTRACION DE RECURSOS
						/*$this->SetFont('Arial','B',6);
						$this->SetXY(257,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $administracion, 2, '.', ',' ),1,2,'R',1);*/
							
						$this->SetFont('Arial','B',6);
						$this->SetXY(257,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $administracion1, 2, '.', ',' ),1,2,'R',1);

						/*$this->SetFont('Arial','B',6);
						$this->SetXY(283,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( ($administracion-$administracion1), 2, '.', ',' ),1,2,'R',1);*/
						
						//TOTALES FILA
						/*$this->SetFont('Arial','B',6);
						$this->SetXY(296,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $IngresoPropio, 2, '.', ',' ),1,2,'R',1);*/
										
						$this->SetFont('Arial','B',6);
						$this->SetXY(296,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( $GastoDirecto, 2, '.', ',' ),1,2,'R',1);
						
						/*$this->SetFont('Arial','B',6);
						$this->SetXY(322,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(39,4,number_format ( ($IngresoPropio-$GastoDirecto), 2, '.', ',' ),1,2,'R',1);*/
						
						//TOTAL				
						$this->SetFont('Arial','B',6);
						$this->SetXY(335,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(15,4,number_format ( ($academico1+$vinculacion1+$planeacion1+$calidad1+$administracion1), 2, '.', ',' ),1,2,'R',1);
		...
		$this->SetXY(101,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[0], 2, '.', ',' ),1,2,'R',1);*/
					
		$this->SetFont('Arial','B',6);
		$this->SetXY(101,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[1], 2, '.', ',' ),1,2,'R',1);

		/*$this->SetFont('Arial','B',6);
		$this->SetXY(127,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( ($Totalaca[0]-$Totalaca[1]), 2, '.', ',' ),1,2,'R',1);*/
					
		//VINCULACION
		/*$this->SetFont('Arial','B',6);
		$this->SetXY(140,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[2], 2, '.', ',' ),1,2,'R',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(140,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[3], 2, '.', ',' ),1,2,'R',1);

		/*$this->SetFont('Arial','B',6);
		$this->SetXY(166,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( ($Totalaca[2]-$Totalaca[3]), 2, '.', ',' ),1,2,'R',1);*/
						
		//PLANEACION
		/*$this->SetFont('Arial','B',6);
		$this->SetXY(179,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[4], 2, '.', ',' ),1,2,'R',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(179,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[5], 2, '.', ',' ),1,2,'R',1);
						
		/*$this->SetFont('Arial','B',6);
		$this->SetXY(205,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( ($Totalaca[4]-$Totalaca[5]), 2, '.', ',' ),1,2,'R',1);*/

		//CALIDAD
		/*$this->SetFont('Arial','B',6);
		$this->SetXY(218,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[6], 2, '.', ',' ),1,2,'R',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(218,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[7], 2, '.', ',' ),1,2,'R',1);

		/*$this->SetFont('Arial','B',6);
		$this->SetXY(244,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( ($Totalaca[6]-$Totalaca[7]), 2, '.', ',' ),1,2,'R',1);*/
					
		//ADMINISTRACION
		/*$this->SetFont('Arial','B',6);
		$this->SetXY(257,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[8], 2, '.', ',' ),1,2,'R',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(257,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[9], 2, '.', ',' ),1,2,'R',1);

		/*$this->SetFont('Arial','B',6);
		$this->SetXY(283,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( ($Totalaca[8]-$Totalaca[9]), 2, '.', ',' ),1,2,'R',1);*/
		...
		$this->SetXY(296,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[10], 2, '.', ',' ),1,2,'R',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(296,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $Totalaca[11], 2, '.', ',' ),1,2,'R',1);
		...
		$this->SetXY(335,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(15,4,number_format ( ($Totalaca[11]), 2, '.', ',' ),1,2,'R',1);	
		...
		$this->SetXY(101,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[0], 2, '.', ',' ),1,2,'C',1);*/
					
		$this->SetFont('Arial','B',6);
		$this->SetXY(101,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[1], 2, '.', ',' ),1,2,'C',1);
		...
		$this->SetXY(140,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[2], 2, '.', ',' ),1,2,'C',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(140,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[3], 2, '.', ',' ),1,2,'C',1);
		...
		$this->SetXY(179,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[4], 2, '.', ',' ),1,2,'C',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(179,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[5], 2, '.', ',' ),1,2,'C',1);
		...
		$this->SetXY(218,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[6], 2, '.', ',' ),1,2,'C',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(218,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[7], 2, '.', ',' ),1,2,'C',1);
		...
		$this->SetXY(257,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[8], 2, '.', ',' ),1,2,'C',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(257,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[9], 2, '.', ',' ),1,2,'C',1);
		...
		$this->SetXY(296,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[10], 2, '.', ',' ),1,2,'C',1);*/
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(296,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( $TotalCapitulo[11], 2, '.', ',' ),1,2,'C',1);
						
		/*$this->SetFont('Arial','B',6);
		$this->SetXY(322,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(39,4,number_format ( ($TotalCapitulo[10]-$TotalCapitulo[11]), 2, '.', ',' ),1,2,'C',1);	*/

		$this->SetFont('Arial','B',6);
		$this->SetXY(335,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(15,4,number_format ( ($TotalCapitulo[11]), 2, '.', ',' ),1,2,'C',1);	
	}
	function Footer()
	{
		$bdd = "sicopre";
