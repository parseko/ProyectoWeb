<?php
	...
	class poa1_anexo2 extends FPDF
	{
		...
		{	
			...
			//Título
			$this->Cell(4,10,'DIRECCIÓN GENERAL DE EDUCACIÓN SUPERIOR TECNOLÓGICA',0,0,'C');
			//Salto de línea
			$this->SetFont('Arial','',10);
			$this->Cell(8,10,'COORDINACIÓN SECTORIAL DE ADMINISTRACIÓN Y FINANZAS',0,0,'C');
			$this->Cell(12,10,"DIRECCIÓN DE RECURSOS FINANCIEROS",0,0,'C');
			$this->Cell(16,10,"SUBPRESUPUESTO DE INVERSIÓN CON CARGO A INGRESOS PROPIOS",0,0,'C');
			$this->Cell(20,10,"(CAPITULO 5000)",0,0,'C');
