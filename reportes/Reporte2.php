...
class ReporteHorario extends FPDF
{
	...
	{	
		...
		$this->SetXY(85,3);
		$this->Cell(36,20,'',0,2,'C');
	    $this->Image("../imagenes/reportes/tec.jpeg",305,3,25,25);
		
		$this->SetFont('Arial','B',7.5);
		$this->SetXY(113,10);
		$this->Cell(35,4,"FORMATO DEL CONCENTRADO POR PARTIDA PRESUPUESTAL Y PROCESO ESTRATEGICO",0,2,'L');
		
		$this->SetFont('Arial','B',7.5);
		$this->SetXY(140,14);
		$this->Cell(35,4,"REFERENCIA A LA NORMA ISO 9001-2000:6.1",0,2,'L');
		...
		$this->Cell(95,4,"PARTIDA",1,2,'C',1);
		...
		$this->SetXY(26,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(80,20,"NOMBRE",1,2,'C',1);
		...
		{
			$sql_apoa_dpto = "SELECT * FROM poa_dpto WHERE idpoa = '{$row_apoa['id']}' AND  idproceso = '{$row_proceso['id']}' GROUP BY idactividad";
			...
			$sql_apoa_dpto = "SELECT * FROM poa_dpto WHERE idpoa = '{$row_apoa['id']}' AND idproceso = '{$row_proceso['id']}' GROUP BY idaccion";
			$res_apoa_dpto = mysql_db_query ( $bdd, $sql_apoa_dpto );
			while ( $row_apoa_dpto = mysql_fetch_assoc ( $res_apoa_dpto ) )
			{
				if($row_proceso['id'] == 1)
	...
	function parteII()
	{
		...
		if ( $row_apoa = mysql_fetch_assoc ( $res_apoa ) )
		{
			...
			while ( $row_partida = mysql_fetch_assoc ( $res_partida ) )
			{
				if($row_partida['clavepartida'] >= 1000 and $row_partida['clavepartida'] <= 1999)
				{
					...
					$administracion1="";
					//{$_SESSION['dpto_id']}
					$sql_deptoapoa = "SELECT * FROM poa_dpto WHERE partida_id='{$row_partida['id']}' AND idpoa='{$row_apoa['id']}' ";
					...
					{	
						...
						$this->SetXY(121+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(18,4,number_format ( $academico, 2, '.', ',' ),1,2,'R',1);
									
						$this->SetFont('Arial','B',6);
						$this->SetXY(139+$y,$x);
						$this->SetFillColor(225,225,225);
						$this->Cell(18,4,number_format ( $academico1, 2, '.', ',' ),1,2,'R',1);
						
						//VINCULACION
						$this->SetFont('Arial','B',6);
						$this->SetXY(157+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(18,4,number_format ( $vinculacion, 2, '.', ',' ),1,2,'R',1);
									
						$this->SetFont('Arial','B',6);
						$this->SetXY(175+$y,$x);
						$this->SetFillColor(225,225,225);
						$this->Cell(18,4,number_format ( $vinculacion1, 2, '.', ',' ),1,2,'R',1);
						
						//PLANEACION
						$this->SetFont('Arial','B',6);
						$this->SetXY(193+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(18,4,number_format ( $planeacion, 2, '.', ',' ),1,2,'R',1);
	
						$this->SetFont('Arial','B',6);
						$this->SetXY(211+$y,$x);
						$this->SetFillColor(225,225,225);
						$this->Cell(18,4,number_format ( $planeacion1, 2, '.', ',' ),1,2,'R',1);
						
						//CALIDAD
						$this->SetFont('Arial','B',6);
						$this->SetXY(229+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(18,4,number_format ( $calidad, 2, '.', ',' ),1,2,'R',1);
									
						$this->SetFont('Arial','B',6);
						$this->SetXY(247+$y,$x);
						$this->SetFillColor(225,225,225);
						$this->Cell(18,4,number_format ( $calidad1, 2, '.', ',' ),1,2,'R',1);
						
						//ADMINISTRACION DE RECURSOS
						$this->SetFont('Arial','B',6);
						$this->SetXY(265+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(18,4,number_format ( $administracion, 2, '.', ',' ),1,2,'R',1);
							
						$this->SetFont('Arial','B',6);
						$this->SetXY(283+$y,$x);
						$this->SetFillColor(225,225,225);
						$this->Cell(18,4,number_format ( $administracion1, 2, '.', ',' ),1,2,'R',1);
						
						//TOTALES FILA
						$this->SetFont('Arial','B',6);
						$this->SetXY(301+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(16,4,number_format ( $IngresoPropio, 2, '.', ',' ),1,2,'R',1);
						...
						$this->SetXY(330+$y,$x);
						$this->SetFillColor(255,255,255);
						$this->Cell(20,4,number_format ( ($IngresoPropio+$GastoDirecto), 2, '.', ',' ),1,2,'R',1);
		...
		$this->SetXY(121+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $Totalaca[0], 2, '.', ',' ),1,2,'R',1);
					
		$this->SetFont('Arial','B',6);
		$this->SetXY(139+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $Totalaca[1], 2, '.', ',' ),1,2,'R',1);
					
		//VINCULACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(157+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $Totalaca[2], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(175+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $Totalaca[3], 2, '.', ',' ),1,2,'R',1);
						
		//PLANEACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(193+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $Totalaca[4], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(211+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $Totalaca[5], 2, '.', ',' ),1,2,'R',1);
						
		//CALIDAD
		$this->SetFont('Arial','B',6);
		$this->SetXY(229+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $Totalaca[6], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(247+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $Totalaca[7], 2, '.', ',' ),1,2,'R',1);
					
		//ADMINISTRACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(265+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $Totalaca[8], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(283+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $Totalaca[9], 2, '.', ',' ),1,2,'R',1);
		...
		$this->SetXY(301+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(16,4,number_format ( $Total, 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(317+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(13,4,number_format ( $Total1, 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(330+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(20,4,number_format ( ($Total1+$Total), 2, '.', ',' ),1,2,'R',1);	
		...
		$this->SetXY(301+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(16,4,number_format ( $Totalaca[10], 2, '.', ',' ),1,2,'R',1);
		...
		$this->SetXY(330+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(20,4,number_format ( ($Totalaca[10]+$Totalaca[11]), 2, '.', ',' ),1,2,'R',1);	
		...
		$this->SetXY(301+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(17,4,number_format ( $Totalaca[10], 2, '.', ',' ),1,2,'R',1);
		...
		$this->SetXY(121+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $TotalCapitulo[0], 2, '.', ',' ),1,2,'R',1);
					
		$this->SetFont('Arial','B',6);
		$this->SetXY(139+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $TotalCapitulo[1], 2, '.', ',' ),1,2,'R',1);
					
		//VINCULACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(157+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $TotalCapitulo[2], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(175+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $TotalCapitulo[3], 2, '.', ',' ),1,2,'R',1);
						
		//PLANEACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(193+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $TotalCapitulo[4], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(211+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $TotalCapitulo[5], 2, '.', ',' ),1,2,'R',1);
						
		//CALIDAD
		$this->SetFont('Arial','B',6);
		$this->SetXY(229+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $TotalCapitulo[6], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(247+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $TotalCapitulo[7], 2, '.', ',' ),1,2,'R',1);
					
		//ADMINISTRACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(265+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(18,4,number_format ( $TotalCapitulo[8], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(283+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(18,4,number_format ( $TotalCapitulo[9], 2, '.', ',' ),1,2,'R',1);
		
		//EXTRA
		$this->SetFont('Arial','B',6);
		$this->SetXY(301+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(16,4,number_format ( $TotalCapitulo[10], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(317+$y,$x);
		$this->SetFillColor(225,225,225);
		$this->Cell(13,4,number_format ( $TotalCapitulo[11], 2, '.', ',' ),1,2,'R',1);
						
		$this->SetFont('Arial','B',6);
		$this->SetXY(330+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(20,4,number_format ( ($TotalCapitulo[10]+$TotalCapitulo[11]), 2, '.', ',' ),1,2,'R',1);	
		...
		$this->SetXY(121+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(36,4,number_format ( ($TotalCapitulo[0]+$TotalCapitulo[1]), 2, '.', ',' ),1,2,'R',1);
					
		//VINCULACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(157+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(36,4,number_format ( ($TotalCapitulo[2]+$TotalCapitulo[3]), 2, '.', ',' ),1,2,'R',1);
						
		//PLANEACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(193+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(36,4,number_format ( ($TotalCapitulo[4]+$TotalCapitulo[5]), 2, '.', ',' ),1,2,'R',1);
						
		//CALIDAD
		$this->SetFont('Arial','B',6);
		$this->SetXY(229+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(36,4,number_format ( ($TotalCapitulo[6]+$TotalCapitulo[7]), 2, '.', ',' ),1,2,'R',1);
											
		//ADMINISTRACION
		$this->SetFont('Arial','B',6);
		$this->SetXY(265+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(36,4,number_format ( ($TotalCapitulo[8]+$TotalCapitulo[9]), 2, '.', ',' ),1,2,'R',1);
		
		//EXTRA
		$this->SetFont('Arial','B',6);
		$this->SetXY(301+$y,$x);
		$this->SetFillColor(255,255,255);
		$this->Cell(29,4,number_format ( ($TotalCapitulo[0]+$TotalCapitulo[1]+$TotalCapitulo[2]+$TotalCapitulo[3]+$TotalCapitulo[4]+$TotalCapitulo[5]+$TotalCapitulo[6]+$TotalCapitulo[7]+$TotalCapitulo[8]+$TotalCapitulo[9]), 2, '.', ',' ),1,2,'R',1);
